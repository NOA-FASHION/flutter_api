...
class ListMission extends StatefulWidget {
  const ListMission({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return ListView.builder(
        itemCount: missionsController.MissionList.length,
